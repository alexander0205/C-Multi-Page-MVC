...
CkEditorImageBrowser.initEventHandlers = function () {
    ...
    $(document).on('click', '.js-image-link', function () {
        //alert(CkEditorImageBrowser.ckFunctionNum);
        //window.opener.window[CkEditorImageBrowser.ckFunctionNum]("ss");.
  
    var txtName = window.opener.document.getElementById(CkEditorImageBrowser.ckFunctionNum);
    txtName.value = $(this).data('url');

    var image = window.opener.document.getElementById(CkEditorImageBrowser.ckFunctionNum + "_image");
